...
const initialFormData: RegistrationPayload = {
  ...
  preparedBy: '',
  cnpj: '',
  brasilApiSimplesOption: null,
  brasilApiMeiOption: null,
  brasilApiSimplesOptionDate: null,
  brasilApiSimplesExclusionDate: null,
  brasilApiMeiOptionDate: null,
  brasilApiMeiExclusionDate: null,
  companyName: '',
  tradeName: '',
  commercialRegistry: '',
  businessActivity: '',
